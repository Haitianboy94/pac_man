...
> ⚠️ **The game configuration will be updated during the defense.**
...
You must implement a persistent highscore system. The exact implementation is up to you, but document it in the README.
